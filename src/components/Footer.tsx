...
export function GithubSolid(props: SVGProps<SVGSVGElement>) {
	return (
		<svg
		...
		<footer>
			<div className='w-full flex flex-col items-center gap-4 border-t-1 border-neutral-800 p-4'>
				<div className="flex flex-row items-center gap-3">
					<p className="text-lg">Por Joaquín Canto:</p>
					<Tooltip
					...
					>
						<Link
							...
							isBlock
							isExternal
							href="https://github.com/JoaquinCanto">
							<Button
								isIconOnly
								color="primary"
								variant="ghost"
							>
								<GithubSolid className="w-8 h-8" />
							</Button>
						</Link>
					</Tooltip>
				</div>
